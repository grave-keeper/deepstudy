...
if (params.get('success')) {
    switch (params.get('success')) {
        case 'google-callback':
            toast({ status: true, message: 'Successfully Sign In With Google' })
            break
        case 'github-callback':
            toast({ status: true, message: 'Successfully Sign In With GitHub' })
            break
        case 'register':
    ...
    switch (params.get('error')) {
        ...
        case 'invalid-register-id':
            toast({ status: false, message: 'Register Session Expired, Try Again' })
            break
        default:
