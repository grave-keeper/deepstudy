...
dropdownFilter.forEach((elm) => {
    elm.onclick = (event) => {
        ...
        ulFilter.style.display =
            getComputedStyle(ulFilter).display === "none" ? "block" : "none";
...
document.addEventListener("click", () => {
    document
        .querySelectorAll(
            "#pyq-container > #filter-container > .filter-item > ul",
        )
        .forEach((elm) => {
...
const filterBtn = document.querySelector(
    "#pyq-container > #filter-container > li > button",
);
